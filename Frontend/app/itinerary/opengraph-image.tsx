...
export const alt = 'My NaviiGo Itinerary';
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: 40, color: '#94a3b8', marginTop: 40, maxWidth: 800, lineHeight: 1.4 }}>
            Check out this day-by-day spiritual journey planner created with NaviiGo.
          </p>
        </div>

        <div style={{ position: 'absolute', bottom: 60, right: 80, display: 'flex', alignItems: 'center' }}>
          <span style={{ color: '#38bdf8', fontSize: 32, fontWeight: 600 }}>View full itinerary →</span>
        </div>
      </div>
    ),
    { ...size }
