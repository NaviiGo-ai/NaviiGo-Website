      ...
      <div className="max-w-5xl mx-auto px-4 space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-2">
            ...
            <div className="h-4 w-40 bg-muted/70 rounded-lg" />
          </div>
        ...
        <div className="flex gap-4">
          {[...Array(4)].map((_, i) => (
            <div key={i} className="h-16 flex-1 bg-muted rounded-2xl" />
          ))}
        </div>
        ...
        <div className="flex gap-2 overflow-hidden">
          {[...Array(5)].map((_, i) => (
            <div key={i} className="h-10 w-20 bg-muted rounded-xl shrink-0" />
          ))}
        </div>
        ...
        <div className="space-y-4">
          {[...Array(4)].map((_, i) => (
            <div key={i} className="bg-card rounded-2xl p-5 flex gap-4">
