      ...
      <div className="max-w-6xl mx-auto px-6" ref={textRef}>
        ...
        <div className="space-y-32">
          <div className="reveal-text grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-semibold tracking-tight">
              Redefining <br/> The Way You <span className="text-deep-sea-600 dark:text-deep-sea-500 italic font-serif">Travel.</span>
            </h2>
            <p className="text-lg md:text-2xl text-muted-600 dark:text-muted-400 font-light leading-relaxed">
          ...
          <div className="reveal-text grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-semibold tracking-tight order-1 md:order-2">
              Fragmented Planning. <br/> <span className="text-saffron-500 dark:text-saffron-400 italic font-serif">Solved.</span>
            </h2>
          </div>
        </div>
        ...
        <div className="mt-40 reveal-text">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-semibold tracking-tight">
              Meet the <span className="text-deep-sea-600 dark:text-deep-sea-500 italic font-serif">Visionaries.</span>
            </h2>
            <p className="mt-6 text-lg md:text-xl text-muted-600 dark:text-muted-400 font-light max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Team Member 1 */}
            <div className="group relative rounded-[2rem] overflow-hidden bg-white dark:bg-[#0a0a0a] border border-muted-200 dark:border-muted-800/50 p-6 transition-all hover:-tranmuted-y-2 hover:shadow-2xl dark:hover:shadow-deep-sea-900/20">
              <div className="aspect-square w-full rounded-3xl overflow-hidden mb-6 relative flex items-center justify-center bg-gradient-to-br from-deep-sea-600 to-indigo-700 dark:from-deep-sea-800 dark:to-indigo-950" role="img" aria-label="Param Nainani">
              ...
              <p className="text-deep-sea-600 dark:text-deep-sea-400 font-medium mb-3">CEO</p>
            </div>

            {/* Team Member 2 */}
            <div className="group relative rounded-[2rem] overflow-hidden bg-white dark:bg-[#0a0a0a] border border-muted-200 dark:border-muted-800/50 p-6 transition-all hover:-tranmuted-y-2 hover:shadow-2xl dark:hover:shadow-deep-sea-900/20">
              <div className="aspect-square w-full rounded-3xl overflow-hidden mb-6 relative flex items-center justify-center bg-gradient-to-br from-indigo-600 to-indigo-700 dark:from-indigo-800 dark:to-indigo-950" role="img" aria-label="Manpreet Singh">
              ...
              <p className="text-deep-sea-600 dark:text-deep-sea-400 font-medium mb-3">COO</p>
            </div>

            {/* Team Member 3 */}
            <div className="group relative rounded-[2rem] overflow-hidden bg-white dark:bg-[#0a0a0a] border border-muted-200 dark:border-muted-800/50 p-6 transition-all hover:-tranmuted-y-2 hover:shadow-2xl dark:hover:shadow-deep-sea-900/20">
              <div className="aspect-square w-full rounded-3xl overflow-hidden mb-6 relative flex items-center justify-center bg-gradient-to-br from-sky-600 to-deep-sea-800 dark:from-sky-800 dark:to-deep-sea-950" role="img" aria-label="Ojaswee Upadhyay">
              ...
              <p className="text-deep-sea-600 dark:text-deep-sea-400 font-medium mb-3">CTO</p>
            </div>

            {/* Team Member 4 */}
            <div className="group relative rounded-[2rem] overflow-hidden bg-white dark:bg-[#0a0a0a] border border-muted-200 dark:border-muted-800/50 p-6 transition-all hover:-tranmuted-y-2 hover:shadow-2xl dark:hover:shadow-deep-sea-900/20">
              <div className="aspect-square w-full rounded-3xl overflow-hidden mb-6 relative flex items-center justify-center bg-gradient-to-br from-indigo-600 to-fuchsia-700 dark:from-indigo-800 dark:to-fuchsia-950" role="img" aria-label="Lavish Sharma">
              ...
              <p className="text-deep-sea-600 dark:text-deep-sea-400 font-medium mb-3">CFO</p>
            </div>

            {/* Team Member 5 */}
            <div className="group relative rounded-[2rem] overflow-hidden bg-white dark:bg-[#0a0a0a] border border-muted-200 dark:border-muted-800/50 p-6 transition-all hover:-tranmuted-y-2 hover:shadow-2xl dark:hover:shadow-deep-sea-900/20">
              <div className="aspect-square w-full rounded-3xl overflow-hidden mb-6 relative flex items-center justify-center bg-gradient-to-br from-cyan-600 to-deep-sea-700 dark:from-cyan-800 dark:to-deep-sea-950" role="img" aria-label="Nikhil Bhatt">
              ...
              <p className="text-deep-sea-600 dark:text-deep-sea-400 font-medium mb-3">CMO</p>
            </div>
          </div>
        </div>
