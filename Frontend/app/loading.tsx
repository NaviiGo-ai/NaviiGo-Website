  ...
  return (
    <div className="min-h-screen bg-background animate-pulse">
      ...
      <div className="flex flex-col items-center justify-center min-h-[90vh] gap-6 px-4">
        ...
        <div className="h-14 w-3/4 max-w-2xl bg-muted rounded-2xl" />
        <div className="h-14 w-2/3 max-w-xl bg-muted/70 rounded-2xl" />
        <div className="h-5 w-96 bg-muted rounded-full" />
        <div className="flex gap-4 mt-4">
          <div className="h-12 w-40 bg-muted/70 rounded-xl" />
          <div className="h-12 w-36 bg-muted rounded-xl" />
        </div>
      </div>
      {/* Destination cards row */}
      <div className="max-w-7xl mx-auto px-6 pb-24">
        <div className="h-8 w-48 bg-muted rounded-xl mb-8" />
