...
export const PassportHeader = memo(({ stats, levelTitle }: Props) => {
  return (
    <div className="bg-gradient-to-r from-emerald-600 to-teal-700 rounded-[2.5rem] p-8 text-white shadow-xl mb-8 max-w-6xl mx-auto">
      <div className="flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="flex items-center gap-5">
          ...
          <div>
            ...
            <p className="text-emerald-100 text-sm mt-1">Verified check-ins, stamps, and state coverage across India</p>
          </div>
        </div>

        <div className="flex items-center gap-6 bg-white/10 backdrop-blur-md p-4 rounded-2xl border border-white/10">
          <div className="text-center px-2">
            <div className="text-xs text-emerald-100 font-medium">Stamps</div>
            <div className="text-2xl font-black">{stats.totalStamps}</div>
          </div>
          <div className="h-8 w-px bg-white/20" />
          <div className="text-center px-2">
            <div className="text-xs text-emerald-100 font-medium">Total XP</div>
            <div className="text-2xl font-black text-amber-300">{stats.totalXP}</div>
          </div>
          <div className="h-8 w-px bg-white/20" />
          <div className="text-center px-2">
