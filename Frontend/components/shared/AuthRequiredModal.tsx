...
export default function AuthRequiredModal({ open, onClose, dismissible = true }: AuthRequiredModalProps) {
  ...
  return (
    <div className={`fixed inset-0 z-[200] flex items-center justify-center p-4 ${dismissible ? '' : 'bg-muted-950/65 backdrop-blur-sm'}`} role="dialog" aria-modal="true" aria-labelledby="auth-required-title">
      ...
      <div className="relative w-full max-w-md rounded-3xl border border-white/10 bg-white p-6 shadow-2xl dark:bg-muted-900 sm:p-8">
        ...
        <h2 id="auth-required-title" className="text-2xl font-bold text-muted-950 dark:text-white">Save your trip with NaviiGo</h2>
