    ...
    if (process.env.NODE_ENV === 'production') {
      securityHeaders.push({
        ...
        value: [
          ...
          "connect-src 'self' wss: ws: *.googleapis.com *.google.com apis.google.com *.firebaseio.com *.firebaseapp.com identitytoolkit.googleapis.com securetoken.googleapis.com api.pinecone.io *.open-meteo.com *.sentry.io *.nominatim.openstreetmap.org nominatim.openstreetmap.org router.project-osrm.org *.tile.openstreetmap.org tile.openstreetmap.org *.tile.openstreetmap.fr tile.openstreetmap.fr www.googletagmanager.com www.google-analytics.com analytics.google.com tpwgts.com *.onrender.com ipapi.co unpkg.com *.basemaps.cartocdn.com server.arcgisonline.com *.arcgisonline.com *.apistp.com",
          "img-src 'self' data: blob: https: *.tile.openstreetmap.org *.tile.openstreetmap.fr *.basemaps.cartocdn.com server.arcgisonline.com *.arcgisonline.com",
          "media-src 'self'",
